...
if($action == '') {
	...
	echo '<a href="'.url::backend('media', ['subpage'=>'popup', 'action'=>'add', 'id'=>$id]).'" class="btn btn-sm btn-primary pull-right">'.lang::get('add').'</a>';
	...
	while($table->isNext()) {
		...
		$edit = '<a href="'.url::backend('media', ['subpage'=>'popup', 'action'=>'edit', 'id'=>$table->get('id')]).'" class="btn btn-sm  btn-default">'.lang::get('edit').'</a>';
		$delete = '<a href="'.url::backend('media', ['subpage'=>'popup', 'action'=>'delete', 'id'=>$table->get('id')]).'" class="btn btn-sm btn-danger">'.lang::get('delete').'</a>';
