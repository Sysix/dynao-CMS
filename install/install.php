...
$sql->query('CREATE TABLE IF NOT EXISTS `structure_block` (
  ...
  `media1` 		int(16)					NOT NULL,
  `media2` 		int(16)					NOT NULL,
  `media3` 		int(16)		 			NOT NULL,
  `media4` 		int(16)					NOT NULL,
  `media5` 		int(16)					NOT NULL,
  `media6` 		int(16)					NOT NULL,
  `media7`		int(16)					NOT NULL,
  `media8` 		int(16)					NOT NULL,
  `media9` 		int(16)		 			NOT NULL,
  `media10` 	int(16)		 			NOT NULL,
  `php1` 		text 					NOT NULL,
  `php2` 		text 					NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;');
